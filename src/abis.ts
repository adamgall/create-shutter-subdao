...
export const RealityModuleETHAbi = [
  {
    inputs: [
      ...
      { internalType: "contract RealitioV3", name: "_oracle", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32[]", name: "txHashes", type: "bytes32[]" },
    ],
    name: "addProposal",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    name: "oracle",
    outputs: [
      { internalType: "contract RealitioV3", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "address", name: "arbitrator", type: "address" }],
    name: "setArbitrator",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "uint256", name: "bond", type: "uint256" }],
    name: "setMinimumBond",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "uint32", name: "cooldown", type: "uint32" }],
  ...
  {
    inputs: [{ internalType: "uint32", name: "timeout", type: "uint32" }],
